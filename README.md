...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/armored-core-project-phantasma-recomp/total)](https://github.com/Alexbeav/armored-core-project-phantasma-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/armored-core-project-phantasma-recomp/latest/total)](https://github.com/Alexbeav/armored-core-project-phantasma-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/armored-core-project-phantasma-recomp)](https://github.com/Alexbeav/armored-core-project-phantasma-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->
...
This is an owned-input setup kit. You supply your own SLUS-00670 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00670 |
| Discs | 1 |
| Supported dump | Redump `Armored Core - Project Phantasma (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/armored-core-project-phantasma-recomp/releases)
   and extract it into a writable folder.
2. Start `Armored_Core_Project_Phantasma` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Armored_Core_Project_Phantasma.exe` and start the game as
usual, or run `Armored_Core_Project_Phantasma.exe --diagnostic`. Reproduce the problem, quit, then
run `Armored_Core_Project_Phantasma.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
