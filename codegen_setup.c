...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "ARMORED_CORE_PROJECT_PHANTASMA_PROJECT_ROOT",
    .build_dir_env = "ARMORED_CORE_PROJECT_PHANTASMA_BUILD_DIR",
    .force_setup_env = "ARMORED_CORE_PROJECT_PHANTASMA_FORCE_SETUP",
    ...
    .exe_basename = "Armored_Core_Project_Phantasma",
    .prepare_note =
